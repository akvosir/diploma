...
public class AdapterCompare extends RecyclerView.Adapter<AdapterCompare.ListViewHolder> {
    private List<Product> productList;
    private Context mctx;


    public AdapterCompare(List<Product> productList, Context mctx) {
        this.productList = productList;
        this.mctx = mctx;
    }

    @Override
    public AdapterCompare.ListViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_product_item, viewGroup, false);
        return new AdapterCompare.ListViewHolder(v);
    }

    @Override
    public void onBindViewHolder(AdapterCompare.ListViewHolder holder, int position) {
